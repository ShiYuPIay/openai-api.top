...
import { CONNECT_TIMEOUT_MS } from "../runtime/constants.js";
import { closeTCPSocketQuietly } from "../runtime/sockets.js";
import { textDecoder, textEncoder } from "../tls/client.js";
...
export async function turnConnect(proxy, targetHost, targetPort, TCP连接) {
	...
	const close = () => {
		closeTCPSocketQuietly(controlSocket);
		closeTCPSocketQuietly(dataSocket);
	};
