...
import { getCloudflareUsage } from "../cloudflare/usage.js";
import { 读取config_JSON } from "../config/store.js";
import { 获取传输协议配置, 获取传输路径参数值, 随机路径 } from "../config/transport.js";
import { 处理gRPC请求 } from "../handlers/grpc.js";
import { 处理WS请求 } from "../handlers/websocket.js";
import { 处理XHTTP请求 } from "../handlers/xhttp.js";
import { html1101, nginx } from "../http/pages.js";
import { isIPHostname } from "../network/address.js";
import { 生成随机IP, 识别运营商 } from "../network/operator.js";
import { 请求日志记录 } from "../observability/request-log.js";
import { base64SecretEncode, 反代参数获取, 获取SOCKS5账号, 获取代理默认端口 } from "../proxy/config.js";
...
import { 整理成数组 } from "../runtime/arrays.js";
import { 拼接字节数据 } from "../runtime/bytes.js";
import { Pages静态页面, Version, 特征码字典 } from "../runtime/constants.js";
import { MD5MD5 } from "../runtime/hash.js";
import { log } from "../runtime/logging.js";
import { 替换星号为随机字符 } from "../runtime/random.js";
import { 配置运行时 } from "../runtime/settings.js";
import { Clash订阅配置文件热补丁, Singbox订阅配置文件热补丁, Surge订阅配置文件热补丁 } from "../subscriptions/patches.js";
import { 获取优选订阅生成器数据, 请求优选API } from "../subscriptions/sources.js";
						...
						try {
							...
							try {
								...
								try {
									...
									closeTCPSocketQuietly(tlsSocket || tcpSocket)
								}
							} catch (error) {
