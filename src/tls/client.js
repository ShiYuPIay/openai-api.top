import { 数据转Uint8Array } from "../runtime/bytes.js";
...
export class TlsClient {
	...
	async readChunk(reader) { return this.timeout ? Promise.race([reader.read(), new Promise(((_, reject) => setTimeout((() => reject(new Error("TLS read timeout"))), this.timeout)))]) : reader.read() }
	...
	close() { closeTCPSocketQuietly(this.socket) }
}
